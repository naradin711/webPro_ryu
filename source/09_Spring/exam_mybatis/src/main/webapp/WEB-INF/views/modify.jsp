...
<body>
	<!-- 뿌릴 dto는 ${board} / 파라미터는 ${param.bid}  ${param.pageNum}-->
	<form action="${conPath}/modify.do" method="post">
		...
		<table>
			...
			<tr> 
				<th>작성자</th> 
				<td><input type="text" name="bname" value="${board.bname }" readonly="readonly"></td> 
			</tr>
			<tr> 
				<th>글제목</th> 
			...
			<tr> 
				<th>본문</th> 
				<td><textarea rows="5" cols="20" name="bcontent">${board.bcontent }</textarea></td> 
			</tr>
			<tr> 
				<td colspan="2">
