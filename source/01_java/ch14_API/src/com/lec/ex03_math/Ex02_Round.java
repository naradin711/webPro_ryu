...
public class Ex02_Round {
   public static void main(String[] args) {
	  ...
	  System.out.println("소수점 첫째 자리에서 반올림, 올림, 버림");
	  System.out.println("9.15를 올림 : " + Math.ceil(9.15*10)/10); //9.2를 나오도록 하는 것.
	  System.out.println("9.15를 반올림 : " + Math.round(9.15*10)/10.0); //반드시 10.0을 할 것.
	  System.out.println("9.15를 올림 : " + Math.floor(9.15*10)/10);
