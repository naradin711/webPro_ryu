...
<body>
	...
	<div id="content_form" >
		<form action="${conPath }/WriteReview.do?pid=${param.pid }" method="post" enctype="multipart/form-data">
			 <input type="hidden" name="pid" value="${param.pid }">
			 <table>
				<caption>리 뷰 쓰 기</caption>
				<tr> <th>작성자</th> <td><input type="text" name="cid" required="required" value="${customer.cid }" readonly="readonly"></td> </tr>
				<tr> <th>리뷰제목</th> <td><input type="text" name="rbtitle" required="required"></td> </tr>
				<tr> 
					<th>상품설명</th> 
					<td><textarea rows="10" cols="30" name="rbcontent"></textarea></td> 
				</tr>
				<tr> 
					<th>상품사진</th> 
